...
echo "  bun run pcbkit:route        # primary circuit-json route"
echo "  bun run pcbkit:assure       # gates vs pinned manufacturing PCB"
echo "  bun run autoroute:pcbkit    # optional tscircuit HTTP adapter"
echo "  open ci/artifacts/v3-manufacturing.kicad_pro"
